...
orig_T = max(s.totalTime, 0) * 1.25;
orig_points = [s.theta1.'; s.theta2.'];
orig_theta1 = orig_points(1,:);
orig_theta2 = orig_points(2,:);

theta1 = [orig_theta1(1)*180/pi  -118.2  -113  orig_theta1(end)*180/pi] * pi/180;
theta2 = [orig_theta2(1)*180/pi     8.2  -26.5 orig_theta2(end)*180/pi] * pi/180;
