...
public class CenterOnePieceBalanceAuto extends AutoMode {
    static {
        ...
        Pose2d backupChargeStation = new Pose2d(
            new Translation2d(
                FieldDimensions.StagingLocations.translations[1].getX() - Units.inchesToMeters(2 * onePointTurnRadius + Constants.kCenterToIntake),
                scoringPose.getTranslation().getY()
            ),
            Rotation2d.fromDegrees(180)
        );
        Pose2d onePointTurn = new Pose2d(
            FieldDimensions.StagingLocations.translations[1].plus(new Translation2d(
    ...
    public CenterOnePieceBalanceAuto() {
