function field = get_field_positions(center_to_side_bumper)
...
field.pole_dia = 1.66;
field.low_pole.x  = center_to_side_bumper + 14.25/2;
field.low_pole.y  = 0.0;
field.mid_pole.x  = center_to_side_bumper + 22.75;
field.mid_pole.y  = 34.0;
field.high_pole.x = center_to_side_bumper + 39.75;
field.high_pole.y = 46.0;
field.dbl_substation.x      = center_to_side_bumper;
